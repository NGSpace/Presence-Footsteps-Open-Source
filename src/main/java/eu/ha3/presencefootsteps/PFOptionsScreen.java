        ...
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(createVolumeOption("volume.player", 100, 0, 100, config::getPlayerVolume, config::setPlayerVolume))
                                ...
                                .option(createVolumeOption("volume.wet", 50, 0, 100, config::getWetVolume, config::setWetVolume))
                                .option(createVolumeOption("volume.foliage", 100, 0, 100, config::getFoliageVolume, config::setFoliageVolume))
