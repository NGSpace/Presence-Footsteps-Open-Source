                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        ...
                                        .binding(true, config::getEnabledMP, config::setMultiplayer)
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<EntitySelector>createBuilder()
                                        ...
                                        .build())
                                .option(createOnOffOption("footwear", true, config::getEnabledFootwear, config::setGlobal))
                                .option(createOnOffOption("exclusive_mode", false, config::isExclusiveMode, config::setExclusive))
                                .build())
                        .group(OptionGroup.createBuilder()
